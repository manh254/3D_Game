...
public class ZombieSpawner : MonoBehaviour
{
    ...
    private float cooldownStartSpawnZombie2 = 10.0f;
    private float cooldownStartSpawnZombie3 = 15.0f;
    ...
    IEnumerator SpawnZombie1()
    {
        ...
        for (int i = 0; i < zombieBlueprint[0].amount; i++)
        {
            ...
            GameObject myZombie = Instantiate(zombieBlueprint[0].GetZombiePrefabs(), spawnPoints[r].position, Quaternion.Euler(0, -90, 0));
        }
    }
    ...
    IEnumerator SpawnZombie2()
    {
        ...
        {
            yield return new WaitForSeconds(cooldownStartSpawnZombie2);
            cooldownStartSpawnZombie2 = cooldownSpawnZombie2;
            int r = Random.Range(0, spawnPoints.Length);
            GameObject myZombie = Instantiate(zombieBlueprint[1].GetZombiePrefabs(), spawnPoints[r].position, Quaternion.Euler(0, -90, 0));
        }
    }
    ...
    IEnumerator SpawnZombie3()
    {
        ...
        {
            yield return new WaitForSeconds(cooldownStartSpawnZombie3);
            cooldownStartSpawnZombie3 = cooldownSpawnZombie3;
            int r = Random.Range(0, spawnPoints.Length);
            GameObject myZombie = Instantiate(zombieBlueprint[2].GetZombiePrefabs(), spawnPoints[r].position, Quaternion.Euler(0, -90, 0));
        }
    }
